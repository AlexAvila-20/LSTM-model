...
parte, encapsula la organización espacial de los sistemas convectivos, 
actuando como un predictor de la actividad convectiva de gran
...
reproducible y de fácil actualización para esta región en INSIVUMEH.
...
cero, pequeñas desviaciones absolutas producen métricas desfavorables 
de eficiencia relativa. En febrero y diciembre la correlación de Pearson es negativa
($r = -0.033$ y $r = -0.246$, respectivamente), lo que indica que el modelo no logra
reproducir con precisión la variabilidad espacial de la precipitación residual en estos meses. Esto
...
\subsection*{Meses de transición y comienzo de la época lluviosa (abril--junio)}
...
del primer evento lluvioso significativo puede diferir en gran manera entre años. A pesar de
...
de $r = 0.588$, indicando que el modelo captura la tendencia general pero no
las magnitudes exactas.
...
\subsection*{Segundo pico de la época lluviosa (agosto--octubre)}
...
lluviosa. La arquitectura con modulación por coordenadas geográficas
contribuye a esta especificidad espacial, permitiendo que el modelo aprenda sesgos
locales mediante el sesgo por píxel aprendible.
...
otros modelos globales, introduce un límite en la capacidad del modelo para
