...
\begin{itemize}
    ...
    \item \textbf{Validación:} Período intermedio (~30-20\%). Monitorea el desempeño fuera de muestra durante el entrenamiento, permitiendo la detención temprana (\textit{early stopping}) para evitar sobreajuste.
\end{itemize}
...
Se desarrolló un programa de diagnósticos exhaustivos (\texttt{DIAGNÓSTICOS.py}) generando figuras y reportes estadísticos completos. Entre los diagnósticos clave se encuentran:
...
Este tipo de recorte geográfico es útil para validación regional y para productos operativos específicos de una zona. Por ejemplo, para propósitos de este documento, se considera el shape asociado a Bocacosta y se realizan los diagnósticos de acuerdo a las variables de esa región.
