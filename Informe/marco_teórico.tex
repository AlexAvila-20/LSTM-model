...
La humedad específica (\(q\)) en niveles bajos y medios (850-700 hPa) es un indicador directo de la materia prima disponible para la convección. La humedad relativa (\(HR\)) proporciona información sobre qué tan cerca de la saturación se encuentra una columna atmosférica, siendo crucial para activar la convección. 
